...
Disclamer: This is just a list of patterns that I found useful. It is not exhaustive and it is not a best practice list.
...
impl Foo {
    ...
    pub fn with_bar(mut self, bar: String) -> FooBuilder {
        self.bar = Some(bar);
        self
    }
}
...
Simply put, the question mark operator is a shortcut for unwrapping a Result or an Option. It is used to propagate errors up the call stack.
