...
In this repository https://github.com/Its-Just-Nans/mouse-data-transfer, we explore the idea of using a mouse to transfer data between two devices. The concept is simple: use the mouse's mouvement to transfer data. The mouse is connected to a device, and the data is sent through the mouse's movement.
...
This application has two part, on the phone side, it will act as a sender where the screen of the phone will display moving pixels that will trigger the mouse to move. On the desktop side, it will act as a receiver where the mouse movement will be captured and converted into data.
...
- problem when trying to trigger the mouse mouvement with the phone screen, it is not very reliable
